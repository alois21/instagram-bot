...
username.send_keys('kamchris18@gmail.com') # Change this to your own Instagram username
password = webdriver.find_element_by_name('password')
password.send_keys('0776920607chris') # Change this to your own Instagram password
